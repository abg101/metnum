...
{	
    ...
    for(int i = 0;i < otra.filas()*otra.columnas();i++)
    {
...
//Algoritmo de multiplicacion de matrices comun y corriente
template<class T>
...
//Algoritmo de multiplicacion de matrices mejorado para aprovechar el uso de cache, anda mas rapido
template<class T>
...
//Multiplicacion de matrices, dependiende de su tamaño conviene la multiplicacion canonica o la mejorada
template<class T>
Matriz<T> operator*(const Matriz<T>& lhs,const Matriz<T>& rhs)
{
    assert(lhs.columnas() == rhs.filas());
...
//Division de matriz por escalar
template<class T>
Matriz<T> operator/(T lhs, const Matriz<T>& rhs)
{
	Matriz<T> res(rhs);
...
//Suma de matrices que modifica la matriz de la izquierda
template<class T>
...
//Copia los datos contenidos de otra matriz segun el rango dado
template<class T>
...
//Multiplica una fila de la matriz por un vector columna
template<class T>
...
//Multiplica una columna de la matriz por un vector fila
template<class T>
...
//Multiplica una fila de la matriz por una columna de otra matriz
template<class T>
...
//Multiplica una columna de la matriz por una fila de otra matriz
template<class T>
...
//Multiplica un bloque de una matriz por un bloque de otra matriz
template<class T>
