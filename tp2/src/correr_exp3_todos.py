...
path_in = "experimentos/experimento3/datos_entrada/{0}_todos_kfold/{0}_K{1}_k{2}_fold{3}.in"
path_out = "derp.out"
path_medidas = "experimentos/experimento3/mediciones_todos_{0}/{0}_{1}_K{2}_k{3}_fold{4}.out.medidas"
